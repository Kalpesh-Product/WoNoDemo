...
const MonthlyBudgetCommon = () => {
  ...
  const columns = [
   ...
   // { headerName: "Section", field: "section", flex: 1.6 },
    ...
    {
      headerName: "Projected Amount (USD)",
      field: "projectedAmount",
      flex: 1,
      valueFormatter: (params) => usdFormat(params.value),
    },
    {
        ...
        >
          <div className="space-y-3">
            ...
            <DetalisFormatted
              ...
              detail={`USD ${Number(selectedRow.projectedAmount || 0).toLocaleString()}`}
            />
            <DetalisFormatted
              title="Actual Amount"
              detail={`USD ${Number(selectedRow.actualAmount || 0).toLocaleString()}`}
            />
