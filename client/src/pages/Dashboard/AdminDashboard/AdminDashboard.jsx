 ...
 const departmentExpenseGraphConfig = [
  {
    ...
    titleAmount: `USD ${Math.round(totalUtilised).toLocaleString("en-US")}`,
  ...
  const dataCardConfigs = [
    ...
    },
    {
      ...
      title: "Average",
      data: `USD ${usdFormat(averageMonthlyExpense)}`,
    ...
    },
    {
      ...
      title: "Total",
      // data: `USD ${usdFormat(totalOverallExpense / totalSqFt)}`,
      data: `USD ${usdFormat(expensePerSqFtTotals.perSqFtExpense)}`,
    ...
    },
    {
      ...
      title: "Total",
      data: `USD ${usdFormat(currentMonthElectricityExpense / totalSqFt)}`,
