...
//         <WidgetSection layout={1} border padding title={"Admin Expense Per Sq. ft"} TitleAmount={`USD 0`}>
...
const AdminPerSqFtExpense = () => {
  ...
  const columns = [
    ...
    { headerName: "Building", field: "buildingName", flex: 1 },
    { headerName: "Expense (USD/sq.ft)", field: "expense",flex: 1 },
  ];
  ...
  return (
    <div className="p-4 flex flex-col gap-4">
      <WidgetSection
        ...
        TitleAmount={`USD ${formatCurrencyWithDecimals(expensePerSqFtTotal)}`}
      >
