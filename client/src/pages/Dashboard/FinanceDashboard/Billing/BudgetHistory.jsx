...
const BudgetHistory = () => {
  ...
  const columns = [
    ...
    { field: "projectedAmount", headerName: "Projected Amount (USD)", flex: 1.2 },
    { field: "actualAmount", headerName: "Actual Amount (USD)", flex: 1.2 },
  ...
  const tableData = budgetHistory
    ...
    .map((item, index) => ({
      ...item,
      srNo: index + 1,
      projectedAmount: usdFormat(item?.projectedAmount || 0),
...
//     { field: "expanseName", headerName: "Expense Name", flex: 1.5 },
//     { field: "expanseType", headerName: "Expense Type", flex: 1.2 },
//     { field: "projectedAmount", headerName: "Amount (USD)", flex: 1.2 },
//     { field: "actualAmount", headerName: "Actual Amount (USD)", flex: 1.2 },
//     { field: "dueDate", headerName: "Due Date", flex: 1.1 },
...
//       return {
//         ...data,
//         projectedAmount: data.projectedAmount.toLocaleString("en-US"),
