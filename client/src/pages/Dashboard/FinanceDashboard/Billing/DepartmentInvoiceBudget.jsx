...
const DepartmentInvoiceBudget = () => {
  ...
  const invoiceCreationColumns = [
    ...
    { headerName: "Projected Amount(USD)", field: "projectedAmount", flex: 1,valueFormatter: (params) => usdFormat(params.value), },
    { headerName: "Actual Amount(USD)", field: "actualAmount", flex: 1,valueFormatter: (params) => usdFormat(params.value), },
        ...
        >
          <div className="space-y-3">
            ...
            <DetalisFormatted
              ...
              detail={`USD ${(viewDetails.projectedAmount || 0).toLocaleString()}`}
            />
            <DetalisFormatted
              title="Actual Amount"
              detail={`USD ${(viewDetails.actualAmount || 0).toLocaleString()}`}
            />
            <DetalisFormatted
              title="Unit"
