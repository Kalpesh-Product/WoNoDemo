    ...
    () =>
      budgetData
        ...
        .map((item) => {
          ...
          return {
            ...item,
            projectedAmount: usdFormat(projectedAmount),
            actualAmount: usdFormat(actualAmount),
            pnl: usdFormat(pnl),
            income: usdFormat(projectedAmount),
            expense: usdFormat(actualAmount),
      ...
      {!isBudgetDataLoading ? (
        <div>
          <WidgetSection
            ...
            TitleAmount={`USD ${usdFormat(totalPnL)}`}
          >
