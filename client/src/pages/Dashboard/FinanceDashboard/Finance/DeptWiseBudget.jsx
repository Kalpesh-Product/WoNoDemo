    ...
    .map((data, index) => {
      ...
      const transoformedRows = Object.values(departmentMap).map(
        (deptRow, index) => ({
          ...deptRow,
          srNo: index + 1,
          actualAmount: usdFormat(deptRow.actualAmount),
          projectedAmount: usdFormat(deptRow.projectedAmount),
        })
      );
      ...
      return {
        ...data,
        projectedAmount: usdFormat(data.projectedAmount),
        amount: usdFormat(data.amount),
        tableData: {
          ...data.tableData,
    ...
    dataLabels: {
      ...
      total: {
        ...
        formatter: (_, config) => {
          ...
          return total ? usdFormat(Number(total)) : "";
        },
        style: {
          fontSize: "12px",
          fontWeight: 600,
  ...
  return (
    // <div className="flex flex-col gap-8">
      ...
      <YearlyGraph
        ...
        TitleAmountTotal={`USD ${usdFormat(selectedYearTotals.projectedTotal)}`}
        TitleAmountGreen={`USD ${usdFormat(selectedYearTotals.actualTotal)}`}
