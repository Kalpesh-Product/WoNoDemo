...
//             .map(
//               (item) =>
//                 `${item.unitNo} - USD ${item.amount.toLocaleString("en-US")}`
//             )
//             .join(", ")
//         : "No unpaid amount";
...
//         <div>Paid: USD ${paidAmount.toLocaleString("en-US")}</div>
      ...
      ">
        ...
        ">
          ...
          <span style="font-weight: 600;">
            USD ${paidAmount.toLocaleString("en-US")}
          </span>
        </div>
        ...
        ">
          ...
          <span style="font-weight: 600;">
            USD ${unpaidTotal.toLocaleString("en-US")}
          </span>
        </div>
    ...
    <div className="flex flex-col gap-4">
      {isError ? (
        ...
        <WidgetSection
          ...
          TitleAmount={`USD ${usdFormat(totalRent)}`}
          border
        >
          <BarGraph
