  ...
  const techWidgets = [
    {
      ...
      widgets: [
        <YearlyGraph
          ...
          TitleAmountGreen={`USD ${usdFormat(selectedFYIncome)}`}
          TitleAmountRed={`USD ${usdFormat(selectedFYExpense)}`}
    ...
    <div className="flex flex-col gap-4 p-4">
      ...
      <div>
        {monthlyProfitLossData.length > 0 ? (
          <WidgetSection
            border
            TitleAmount={`P&L :  USD ${usdFormat(totalPnL)}`}
