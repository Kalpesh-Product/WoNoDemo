...
const totalUtilised = useMemo(() => {
  ...
  const dataCardConfigs = [
    ...
    },
    {
      ...
      title: "Total",
      data: `USD ${usdFormat(internetExpense / totalSqFt)}`,
    ...
    },
    {
      ...
      title: "Total",
      data: `USD ${usdFormat((currentFiscalYearOverallExpense || 0) / totalSqFt)}`,
  ...
  // //       />,
  // //       <DataCard
  // //         data={`USD ${usdFormat((totalOverallExpense || 0) / totalSqFt)}`}
  // //         title={"Total"}
  // //         description={"Expense per sq.ft"}
  // //         route={"per-sq-ft-expense"}
  // //       />,
