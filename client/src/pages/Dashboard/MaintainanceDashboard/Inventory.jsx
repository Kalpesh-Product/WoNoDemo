 ...
 const handleEditInventory = (asset) => {
  ...
  const overallInventoryColumns = [
    ...
    },
    {
      ...
      headerName: "New Purchase Value (USD)",
      cellRenderer: (params) => usdFormat(params.value),
    },
    {
      field: "closingUnits",
  ...
  const unitColumns = [
    ...
    },
    {
      ...
      minWidth: 180,
      flex: 1,
      cellRenderer: (params) => Number(params.value || 0).toLocaleString("en-US"),
    },
    {
                  ...
                  <DetalisFormatted
                    ...
                    detail={
                      selectedAsset.openingPerUnitPrice != null
                        ? `USD ${usdFormat(selectedAsset.openingPerUnitPrice)}`
                        : "N/A"
                    }
                  />
                  <DetalisFormatted
                  ...
                  <DetalisFormatted
                    ...
                    detail={
                      selectedAsset.newPurchasePerUnitPrice != null
                        ? `USD ${usdFormat(selectedAsset.newPurchasePerUnitPrice)}`
                        : "N/A"
                    }
                  />
                  <DetalisFormatted
              ...
              <div>
                ...
                <div className="space-y-4">
                  <DetalisFormatted
                    title="Opening Value"
                    detail={`USD ${
                      usdFormat(selectedAsset.openingInventoryValue) ?? "N/A"
                    }`}
                  />
                  <DetalisFormatted
                    title="New Purchase Value"
                    detail={`USD ${
                      usdFormat(selectedAsset.newPurchaseInventoryValue) ?? "N/A"
                    }`}
                  />
                </div>
              </div>
