    ...
    <div className="w-full">
      ...
      >
        <div className="grid grid-cols-1 gap-2">
          ...
          <DetalisFormatted
            title="Amount (USD)"
            detail={usdFormat(selectedPaymentEntry?.amount || 0) || "USD 0"}
          />
          <DetalisFormatted
          ...
          <DetalisFormatted
            title="GST Amount"
            detail={usdFormat(selectedPaymentEntry?.gstAmount || 0) || "USD 0"}
          />
          <DetalisFormatted
            title="Discount Amount"
            detail={
              usdFormat(selectedPaymentEntry?.discountAmount || 0) || "USD 0"
            }
          />
          <DetalisFormatted
